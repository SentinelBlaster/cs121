...
public class BinarySearchTreeDemo
{
	...
	public void inOrderTraverse(Node currentNode)
	{
		if (currentNode != null)
		{
			...
			System.out.print(currentNode.getKey() + " "); // prchar the current node visited
	...
	public Node getReplacementNode(Node replacedNode)
	{
		...
		// if the replacement isn't the right child, move the replacement charo the parent's left child slot
		// and move the replaced node's right child charo the replacement's right child slot
