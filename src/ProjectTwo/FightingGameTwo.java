...
public class FightingGameTwo {
    public static void main(String[] args) {
        ...
        charAssignmentTwo playerOne = new charAssignmentTwo(roleOne, hpOne, attackOneOne, damageOneOne, speedOneOne, attackOneTwo, damageOneTwo, speedOneTwo);
        ...
        charAssignmentTwo playerTwo = new charAssignmentTwo(roleTwo, hpTwo, attackTwoOne, damageTwoOne, speedTwoOne, attackTwoTwo, damageTwoTwo, speedTwoTwo);
